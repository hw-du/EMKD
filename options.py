...
# Dataset
################
parser.add_argument('--dataset_code', type=str, default='toys', choices=DATASETS.keys())
...
parser.add_argument('--num_positive', type=int, default=8, help='number of positive samples')

parser.add_argument('--N', type=int, default=3, help='number of parallel networks')
